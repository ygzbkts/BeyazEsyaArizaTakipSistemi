...
if(!isset($_SESSION["pid"])) {
    ...
    $sql = "SELECT ar.*, u.ad, u.soyad FROM arizarandevu ar
            ...
            WHERE ar.durum = 2 AND ar.personel = '$personelPid' ORDER BY ar.tarih DESC";
...
<div class="wrapper">
    ...
    <div id="content">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
             ...
             <b><h1 align="center">  İPTAL EDİLEN ARIZALAR <input type="text" class="form-control" id="searchInput" placeholder="Arıza Ara"> </h1> </b>
                </div>
            </nav> 
