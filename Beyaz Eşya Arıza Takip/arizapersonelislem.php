    ...
    <div id="content">
        ...
        <div class="card text-center">
            <div class="container">
                ...
                <form action="arizapersonelislem2.php" method="post">
                    <div class="form-group">
                    <input type="hidden" name="arizaİd" value="<?php echo $_GET["arizaİd"]; ?>">
                        <h5>Müşteriye Not Ekleyin</h5>
                        <textarea name="personel_not" id="" cols="60" placeholder="Mesaj Giriniz" rows="10" required class="form-control"></textarea>
                    </div>
